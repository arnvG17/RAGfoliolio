...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="relative min-h-[85vh] flex items-center bg-black overflow-hidden py-48">
      {/* Zenitsu Animation - Fixed to Left Side */}
      <ZenitsuAnimation />

      <div className="container relative z-10 mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-3xl">
          ...
          <div
            ...
            className={`mb-12 transition-all duration-1000 ${headerRef.isVisible ? 'animate-pop-in' : 'opacity-0 scale-95 translate-y-12 blur-md'
              }`}
          >
            ...
            <h2 className="text-6xl md:text-[9vw] font-black mb-12 tracking-[-0.04em] leading-[0.8]">
              <span className="text-white/95">Ready to</span>
              <br />
              <span className="text-accent">execute?</span>
            </h2>

            <p className="text-white/40 text-lg md:text-xl font-light leading-relaxed mb-6 max-w-lg tracking-tight">
          ...
          <div
            ref={actionsRef.ref}
            className={`flex flex-wrap items-center gap-5 mb-2 transition-all duration-1000 ${actionsRef.isVisible ? 'animate-slide-in-left' : 'opacity-0 -translate-x-12 blur-md'
              }`}
          >
            <FlowButton 
              text="Lets connect"
            ...
            <FlowButton 
              ...
              variant="secondary"
              className="px-14 py-6 text-white/90 border-white/10"
            />
          </div>
          ...
          <div
            ref={linksRef.ref}
            className={`flex items-center gap-x-10 transition-all duration-1000 delay-300 ${linksRef.isVisible ? 'animate-fade-in' : 'opacity-0 translate-y-4 blur-sm'
              }`}
          >
            {[
              ...
              >
                <link.icon className="w-5 h-5 text-white/20 group-hover:text-accent transition-all duration-700 ease-[cubic-bezier(0.2,0.8,0.2,1)]" />
